      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-md-6 text-right">
                <a href="{{route('governorates.create')}}" class="btn btn-primary btn-white">Add New Governorate</a>
            ...
            <tbody>  
              ...
              <tr>
                ...
                <td class="text-center" >
                        <a href="{{url(route('governorates.edit' , $row->id ))}}" title="Edit" class="btn btn-white btn-link btn-sm" data-original-title="Edit">
                                <i class="fas fa-edit"></i>
</a>
</td>
<td class="text-center">
{!! Form::open([
    'action' => ['GovernorateController@destroy',$row->id],
    'method' => 'delete'
]) !!}
